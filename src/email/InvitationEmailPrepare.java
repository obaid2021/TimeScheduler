...
/**
 * This Class reads the participants from the database and sends each participant an invitation via email.
 * 
...
public class InvitationEmailPrepare {
	...
	/**
	 * This functions reads the participants of a particular event from the database.
 ...
 */
	public void send_email_invitation(String email, String name, int eventID , String username) throws SQLException, MessagingException {
		...
		String msg, nameOfEvent = null, date = null, startTime = null, endTime = null, location = null, priority = null ;
